...
var _bitcoinjsLib = __webpack_require__(172);
...
var _SwapAuth = __webpack_require__(203);
...
var _WidthContainer = __webpack_require__(206);
...
var _Coin = __webpack_require__(204);
...
var _Loader = __webpack_require__(207);
...
var setupContract = function setupContract(ethAddress) {
  ...
  tokenContract = new _web2.default.eth.Contract(_humanStandardTokenAbi2.default, _appConfig2.default.services.web3.noxonToken, options);
};
...
var getBalance = function getBalance() {
  ...
  return _helpers.request.get(_appConfig2.default.api.etherscan + '?module=account&action=tokenbalance&contractaddress=' + tokenContract._address + '&address=' + address).then(function (_ref) {
...
var getTransaction = function getTransaction() {
  return new _promise2.default(function (resolve) {
    ...
    var url = ['https://api-rinkeby.etherscan.io/api?module=account&action=tokentx', '&contractaddress=' + tokenContract._address, '&address=' + address, '&startblock=0&endblock=99999999', '&sort=asc&apikey=' + _appConfig2.default.apiKeys.blocktrail].join('');
...
var App = (_dec = (0, _redaction.connect)({
  ...
  App.prototype.render = function render() {
    ...
    var isFetching = !ethAddress || !btcAddress || !tokenAddress || !eosAddress;
...
var _Row = __webpack_require__(209);

var _Row2 = _interopRequireDefault(_Row);

var _Value = __webpack_require__(210);
...
var _Input = __webpack_require__(212);
